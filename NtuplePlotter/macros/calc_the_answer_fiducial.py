...
ttgammaSeq = seq(0.2, 0.7, 0.01) + seq(0.705,1.0,0.005) + seq(1.01, 1.6,0.01) + seq(1.62,3.3,.02)
...
#	TTGammaVis_topAcc = ttgamma_1l_2l_presel / ttgamma_1l_2l_Visnum
	...
	signal_finder.ttgammaSeq = ttgammaSeq
	signal_finder.vgammaSeq = vgammaSeq
	signal_finder.jetSeq = jetSeq
	...
	ttgammaSig,ttgammaSigErr, ttgammaFull,ttgammaFullErr, bestttgSF, bestttgSFErr, bestvgammaSF, bestvgammaSFErr, bestjgSF, bestjgSFErr = signal_finder.calculateTTGamma(progressBar, saveDataFile)
