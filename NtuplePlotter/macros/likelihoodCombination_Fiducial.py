...
#	jghist.GetXaxis().SetTitle('Jet to Photon Scale Factor')
	...
	ttgammaSig = bestttgSF*(e_pho['TTGamma'][0]+mu_pho['TTGamma'][0] + e_ele['TTGamma'][0]+mu_ele['TTGamma'][0] + e_fake['TTGamma'][0]+mu_fake['TTGamma'][0])
	ttgammaSigErr = bestttgSFErr*(e_pho['TTGamma'][0]+mu_pho['TTGamma'][0] + e_ele['TTGamma'][0]+mu_ele['TTGamma'][0] + e_fake['TTGamma'][0]+mu_fake['TTGamma'][0])
